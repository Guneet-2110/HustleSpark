...
import { Clock, Trash2, MessageSquare, Briefcase, Package, ShieldCheck, Store, Loader2, ArrowRight, ShieldAlert } from "lucide-react";
      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-12">
            <Card className="shadow-xl rounded-[2.5rem] border-primary/20 overflow-hidden bg-card/50">
                <CardHeader className="bg-primary/5 border-b">
                    ...
                    <CardDescription>Venture blueprints you have listed for sale.</CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                            ...
                            {myListings.map((l) => (
                                <div key={l.id} className="p-4 border rounded-2xl bg-background/50 flex justify-between items-center group">
                                    ...
                                    <div className="flex gap-2">
                                        <Button variant="outline" size="sm" asChild className="rounded-xl"><Link href={`/marketplace/listing/${l.id}`}>View</Link></Button>
                    ...
                    ) : <div className="text-center py-10 italic text-muted-foreground border-2 border-dashed rounded-3xl">No ventures listed yet.</div>}
                </CardContent>
            </Card>
            ...
            <Card className="shadow-xl rounded-[2.5rem] border-primary/10 overflow-hidden bg-card/50">
                <CardHeader className="bg-primary/5 border-b">
                    ...
                    <CardDescription>Track delivery for your sold intellectual property.</CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                    ...
                    ) : <div className="text-center py-10 italic text-muted-foreground border-2 border-dashed rounded-3xl">No sales recorded.</div>}
                </CardContent>
            </Card>
            ...
            <Card className="shadow-xl rounded-[2.5rem] border-accent/10 overflow-hidden bg-card/50">
                <CardHeader className="bg-accent/5 border-b">
                    ...
                    <CardDescription>Venture assets you have purchased.</CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                    ...
                    ) : <div className="text-center py-10 italic text-muted-foreground border-2 border-dashed rounded-3xl">No acquisitions yet.</div>}
                </CardContent>
            </Card>
        ...
        <div className="lg:col-span-4 space-y-12">
            <Card className="shadow-xl rounded-[2rem] border-primary/10 overflow-hidden">
                <CardHeader className="bg-muted/30"><CardTitle className="text-lg flex items-center gap-2"><Briefcase className="h-5 w-5 text-primary"/>Saved Ideas</CardTitle></CardHeader>
                <CardContent className="p-4 pt-4">
                    ...
                    )) : <p className="text-center text-xs text-muted-foreground py-8 italic">No saved ideas yet.</p>}
                    </div>
                </CardContent>
            </Card>

            <Card className="shadow-xl rounded-[2rem] border-accent/10 overflow-hidden">
                <CardHeader className="bg-muted/30"><CardTitle className="text-lg flex items-center gap-2 text-accent"><MessageSquare className="h-5 w-5"/>Active Support</CardTitle></CardHeader>
                <CardContent className="p-4 pt-4">
                    ...
                    ) : <p className="text-center text-xs text-muted-foreground py-8 italic">No active support channels.</p>}
                </CardContent>
            </Card>
        </div>
      </div>
